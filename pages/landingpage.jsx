  ...
  return (
    <div className="bg-gray-100 mt-[15rem] h-full my-0 mx-auto">
      ...
      >
        ...
        <div
          className="bg-[#fff] rounded-[32px] shadow-sm p-[2.375rem] text-white cursor-pointer max-w-[38rem] md:max-w-[50%] flex flex-col gap-4"
        ...
        >
          ...
          <p className="text-base md:text-[1.125rem] leading-5 md:leading-[1.488rem] text-[#999999] text-center max-w-[30.375rem]">
      ...
      <div className="mt-[10rem] bg-[#C0F000] rounded-lg flex flex-col md:flex-row justify-between  p-[3rem] max-w-[77rem] my-0 mx-auto">
        <div className="mt-[3rem]">
          ...
          <Link href="/cohort" className="">
            <div className="flex gap-1 w-fit mt-[4rem] cursor-pointer">
              <p className="text-base md:text-[1.125rem] leading-5 md:leading-[1.488rem]">
                Join the Network
              </p>
              <Image
                priority
                src="/images/join-network.svg"
                className=""
                height={16.95}
                width={9.55}
                alt=""
