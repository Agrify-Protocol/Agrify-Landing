			...
			<div className='flex flex-col lg:flex-row md:items-center lg:items-start'>
				<div className='w-[100%] lg:w-[50%] h-[18.75rem] md:h-full'>
					<div className='relative'>
						<picture>
							<source type='image/svg+xml' media='(max-width: 600px)' srcset='/images/side-image-sm.svg' />
							<source type='image/svg+xml' media='(max-width: 1024px)' srcset='/images/side-image-md.svg' />
							<source type='image/svg+xml' media='(min-width: 1024px)' srcset='/images/side-image-lg.svg' />
							<img src='/images/side-image-sm.svg' alt='regular pyramid built from four equilateral triangles' />
						</picture>
				...
				<div className='w-[100%] md:w-[50%] md:pl-[3rem]'>
					<div className='flex flex-col justify-center items-center mt-[10rem] gap-[1.5rem] text-center'>
						<div className=''>
							<Image priority src='/images/check.svg' className='block mx-auto' height={20} width={20} alt='' />
						</div>
						<h2 className='font-medium text-xl leading-6 text-[#000] text-center'>You’re In!</h2>
              ...
              Join our community to get the latest updates first! ✨
						...
						<a href='https://t.me/+LzukavSm-9MxY2Y8' target='_blank' rel='noreferrer' className='flex justify-center'>
							<button className='w-[14.125rem] h-[3.5rem] rounded-[32px] py-[1rem] px-[2rem] bg-[#26A5E4] flex items-center justify-center gap-2'>
								<Image priority src='/images/telegram.svg' className='' height={24} width={24} alt='' />
								<span className='text-white leading-6 font-medium m-0 p-0 text-base'>Join Telegram</span>
							</button>
						</a>
					</div>
				</div>
