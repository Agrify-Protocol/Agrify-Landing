...
const Modal = ({ show, onClose }) => {
  return (
    ...
    <>
      <div
        className={`modal fade fixed inset-0 z-[10000] bg-gray-600 bg-opacity-50 top-0 left-0 show w-full h-full outline-none overflow-x-hidden overflow-y-auto ${
          !show && 'hidden'
        }`}
      ...
      >
        <div
          className="modal-dialog modal-dialog-centered relative modal-lg pointer-events-none md:max-w-[90%] lg:max-w-[80%] xl:max-w-[60%]"
          onClick={(e) => e.stopPropagation()}
        >
          <div className="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
            <div className="modal-body relative p-4 flex justify-between items-center py-[4.5rem] px-[4rem] gap-6 flex-wrap md:flex-nowrap overflow-hidden">
